// Location: app/dashboard/founder/messages/page.tsx
// Founder chat with directors and social workers
  ...
  const fetchChannels = async () => {
    try {
      ...
      if (response.ok) {
        ...
        if (data.channels && data.channels.length > 0) setSelectedChannel(data.channels[0])
      }
    } catch (error) {
      ...
      {channels.length === 0 ? (
        <Card>
          <CardContent className="pt-12 pb-12 text-center">
            ...
            <h3 className="text-lg font-medium mb-2">No channels</h3>
